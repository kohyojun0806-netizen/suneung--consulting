...
const GRADE_TO_NUM = { 'no-base': 9, '5-7': 6, '3-4': 3, '2': 2, '1': 1, '100': 1 };
    ...
    <div className={`landing${visible ? ' landing--visible' : ''}${exiting ? ' landing--exit' : ''}`}
      ...
      <div className="landing__sticky-cta-wrap">
        <button
          ...
          aria-label="지금 시작하기"
        >
          <span className="landing__cta-text">지금 시작하기</span>
        </button>
      </div>
...
function WeeklyReportTab({ profile, report, onSubmit, loading }) {
  ...
  const gradePlaceholders = {
    ...
    '1':        { topics: '예: 수능 킬러문항 유형 A 풀이 / 실전 모의고사 반복', difficulties: '예: 추론형 문제에서 논리 비약 발생' },
