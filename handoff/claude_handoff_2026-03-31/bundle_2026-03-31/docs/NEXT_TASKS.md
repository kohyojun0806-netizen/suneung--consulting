...
- [x] Add UI QA checklist with mobile/desktop visual acceptance criteria
- [x] Improve weekly report templates by grade band and writing style
- [x] Optimize AI coach response length/cost with tighter token policy
- [x] Add explicit evidence badges in UI (official/community/youtube-comment confidence)
- [x] Expose sourceRefs + confidence per recommended book in the plan UI
